...
| **Upstream report** | [ScrollPrize/villa#1855](https://github.com/ScrollPrize/villa/issues/1855), with the real-data reproduction and the candidate patch. Two community pull requests implement the fixes on top of it and reproduce the results from this repository: [villa#1876](https://github.com/ScrollPrize/villa/pull/1876) carries this repository's solver patch, and [villa#1864](https://github.com/ScrollPrize/villa/pull/1864) the attachment-step correction, with upstream unit tests in both |
